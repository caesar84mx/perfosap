...
class Contract(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('almacen:contract-detail', args=[str(self.id)])
...
class Provider(LegalEntity):
    ...
    def get_absolute_url(self):
        return reverse('almacen:provider-detail', args=[str(self.id)])
...
class Item(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('almacen:item-detail', args=[str(self.id)])
